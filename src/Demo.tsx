...
const theme = createTheme({
  components: {
    MuiCheckbox: {
      styleOverrides: {
        root: {
          '&:hover': {
            backgroundColor: 'rgba(0, 0, 0, 0.04)' // Ensuring that hoverOpacity is defined
          }
        }
      }
    }
  ...
  palette: {
    action: {
      hoverOpacity: 0.04 // Setting a default hoverOpacity
    }
  }
});
...
export default function SignInSheet() {
  ...
  return (
    <ThemeProvider theme={theme}> {/* Ensuring the theme provider wraps your component */}
      <div style={{
          margin: -8,
          padding: '20px',
          display: "flex",
        ...
        <Card variant="solid" sx={{
          ...
          <div style={{ width: "100%", textAlign: "center" }}>
            ...
            <FormControl>
              ...
              <Typography sx={{ margin: '20px 0' }}>
                Already have an account?{' '}
                <Link href="/sign-in" underline="hover" style={{ color: '#F21D6B' }}>
                  Sign in instead
                </Link>
              </Typography>
              <Typography sx={{ margin: '20px 0' }}>
              ...
              <img id="LinkedIn_logo" src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/LinkedIn_logo_initials.png/600px-LinkedIn_logo_initials.png?20140125013055" alt="LinkedIn logo" style={{
                  cursor: 'pointer',
                  textAlign: 'center',
                  margin: '20px 0',
                  width: '30px',
